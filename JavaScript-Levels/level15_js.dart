...
class Level15JS extends StatefulWidget {
  @override
  _Level15JSState createState() => _Level15JSState();
}

class _Level15JSState extends State<Level15JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'var filteredArray = myArray.____(x => x % 2 !== 0);';

String requirement =
      'Fill in the blank to use the JavaScript "filter" method to filter out even numbers from an array:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'filter';
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level15': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
