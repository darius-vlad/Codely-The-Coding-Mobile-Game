...
class Level16JS extends StatefulWidget {
  @override
  _Level16JSState createState() => _Level16JSState();
}

class _Level16JSState extends State<Level16JS> {
  String question = 'What is the correct way to declare a variable in JavaScript?\n';
  List<String> choices = [
    'A) variable x;',
    'B) var x;',
    'C) x = var;',
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'java_script_levels.level16': true,
    });
      } else {
        // Incorrect answer
