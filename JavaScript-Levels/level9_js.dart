...
class Level9JS extends StatefulWidget {
  @override
  _Level9JSState createState() => _Level9JSState();
}

class _Level9JSState extends State<Level9JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'Car.____.drive = function() {\n    console.log("Driving " + this.make + " " + this.model);\n};';
String requirement =
      'Fill in the blank to add a method named "drive" to the "Car" prototype that logs "Driving [make] [model]":';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'prototype';
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level9': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
