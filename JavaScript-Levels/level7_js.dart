...
class Level7JS extends StatefulWidget {
  @override
  _Level7JSState createState() => _Level7JSState();
}

class _Level7JSState extends State<Level7JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'person.____= "New York";';
String requirement =
      'Fill in the blank to add a new property "city" to the existing object "person":';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level7': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
