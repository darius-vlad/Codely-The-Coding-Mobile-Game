...
class Level19JS extends StatefulWidget {
  @override
  _Level19JSState createState() => _Level19JSState();
}

class _Level19JSState extends State<Level19JS> {
  String question = 'What does the JavaScript "use strict" directive do?\n';
  List<String> choices = [
    'A) Enforces strict data typing;',
    'B) Enables strict mode, which catches common coding mistakes and "unsafe" actions ;',
    'C) Allows the use of deprecated features;',
    'D) Disables all JavaScript features;',
  ];
  int correctIndex = 1;
  int selectedIndex = -1;
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'java_script_levels.level19': true,
    });
      } else {
        // Incorrect answer
              ...
              onPressed: () {
                if (isCorrect == true) {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LevelScrollJS()));
                } else {
                  Navigator.of(context).pop();
                }
              },
