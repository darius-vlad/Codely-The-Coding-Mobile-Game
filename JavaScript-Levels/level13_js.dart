...
class Level13JS extends StatefulWidget {
  @override
  _Level13JSState createState() => _Level13JSState();
}

class _Level13JSState extends State<Level13JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'var myPromise = new ____(function(resolve, reject) {\n    // resolve(value); or reject(error);\n});';
String requirement =
      'Fill in the blank to create a promise in JavaScript:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'Promise';
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level13': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
