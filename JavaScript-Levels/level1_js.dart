...
class Level1JS extends StatefulWidget {
  @override
  _Level1JSState createState() => _Level1JSState();
}

class _Level1JSState extends State<Level1JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = '____ x;';
  String requirement =
      'Fill in the blank to declare a variable in JavaScript:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level1': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
