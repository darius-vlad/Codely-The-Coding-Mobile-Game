...
class Level8JS extends StatefulWidget {
  @override
  _Level8JSState createState() => _Level8JSState();
}

class _Level8JSState extends State<Level8JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'function Car(make, model) {\n    this.make = make;\n    this.model = ____;\n}';
String requirement =
      'Fill in the blank to create a constructor function named "Car" with properties "make" and "model":';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level8': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
