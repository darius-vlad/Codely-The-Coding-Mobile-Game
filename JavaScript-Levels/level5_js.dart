...
class Level5JS extends StatefulWidget {
  @override
  _Level5JSState createState() => _Level5JSState();
}

class _Level5JSState extends State<Level5JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'const square = (____) => num * num;';
  String requirement =
      'Fill in the blank to define an arrow function named "square" that takes a parameter and returns its square:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level5': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
