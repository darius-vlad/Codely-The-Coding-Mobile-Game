...
class Level20JS extends StatefulWidget {
  @override
  _Level20JSState createState() => _Level20JSState();
}

class _Level20JSState extends State<Level20JS> {
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'java_script_levels.level20': true,
    });
      } else {
        // Incorrect answer
