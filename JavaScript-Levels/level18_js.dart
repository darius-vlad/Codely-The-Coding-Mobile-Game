...
class Level18JS extends StatefulWidget {
  @override
  _Level18JSState createState() => _Level18JSState();
}

class _Level18JSState extends State<Level18JS> {
  String question = 'What does the "=== " operator do in JavaScript?\n';
  List<String> choices = [
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'java_script_levels.level18': true,
    });
      } else {
        // Incorrect answer
