...
class Level4JS extends StatefulWidget {
  @override
  _Level4JSState createState() => _Level4JSState();
}

class _Level4JSState extends State<Level4JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'var thirdElement = myArray[____];';
  String requirement =
      'Fill in the blank to access the third element of an array named "myArray":';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level4': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
