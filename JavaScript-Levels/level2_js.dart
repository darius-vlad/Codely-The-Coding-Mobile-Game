...
class Level2JS extends StatefulWidget {
  @override
  _Level2JSState createState() => _Level2JSState();
}

class _Level2JSState extends State<Level2JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'function ____(a, b) {\n    return a + b;\n}';
  String requirement =
      'Fill in the blank to create a function named "add" that takes two parameters and returns their sum:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level2': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
