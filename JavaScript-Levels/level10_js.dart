...
class Level10JS extends StatefulWidget {
  @override
  _Level10JSState createState() => _Level10JSState();
}

class _Level10JSState extends State<Level10JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'function fibonacci(n) {\n    if (n <= 1) return n;\n    return fibonacci(n - 1) + fibonacci(____);\n}';
String requirement =
      'Fill in the blank to write a function named "fibonacci" that returns the nth Fibonacci number using recursion:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level10': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
