...
class Level11JS extends StatefulWidget {
  @override
  _Level11JSState createState() => _Level11JSState();
}

class _Level11JSState extends State<Level11JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'function outer() {\n    var x = 10;\n    function ____() {\n        console.log(x);\n    }\n    return inner;\n}\n';
String requirement =
      'Fill in the blank to create a closure in JavaScript:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level11': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
