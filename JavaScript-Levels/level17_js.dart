...
class Level17JS extends StatefulWidget {
  @override
  _Level17JSState createState() => _Level17JSState();
}

class _Level17JSState extends State<Level17JS> {
  String question = 'What is the purpose of the JavaScript "bind" method?\n';
  List<String> choices = [
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'java_script_levels.level17': true,
    });
      } else {
        // Incorrect answer
