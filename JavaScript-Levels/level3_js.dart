...
class Level3JS extends StatefulWidget {
  @override
  _Level3JSState createState() => _Level3JSState();
}

class _Level3JSState extends State<Level3JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'var myArray = ____;';
  String requirement =
      'Fill in the blank to create an array in JavaScript:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level3': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
