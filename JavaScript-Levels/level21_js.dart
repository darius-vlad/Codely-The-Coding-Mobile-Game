...
class Level21JS extends StatefulWidget {
  @override
  _Level21JSState createState() => _Level21JSState();
}

class _Level21JSState extends State<Level21JS> {
  String question = 'What is the result of the following expression in JavaScript?\n\nconsole.log(typeof(undefined)); \n';
  List<String> choices = [
    'A) "notdefined";',
    'B) "null";',
    'C) "undefined";',
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'java_script_levels.level21': true,
    });
      } else {
        // Incorrect answer
