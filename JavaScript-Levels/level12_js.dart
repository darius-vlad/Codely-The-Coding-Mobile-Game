...
class Level12JS extends StatefulWidget {
  @override
  _Level12JSState createState() => _Level12JSState();
}

class _Level12JSState extends State<Level12JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'var doubledArray = myArray.map(x => ____);';
String requirement =
      'Fill in the blank to use the JavaScript "map" method to double each element of an array:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level12': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
