...
class Level6JS extends StatefulWidget {
  @override
  _Level6JSState createState() => _Level6JSState();
}

class _Level6JSState extends State<Level6JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'var person = {\n    ____: "John",\n    ____: 30\n};';
String requirement =
      'Fill in the blank to create an object in JavaScript with properties "name" and "age":';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'name age';
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level6': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
