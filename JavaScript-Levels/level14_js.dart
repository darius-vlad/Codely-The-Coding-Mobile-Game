...
class Level14JS extends StatefulWidget {
  @override
  _Level14JSState createState() => _Level14JSState();
}

class _Level14JSState extends State<Level14JS> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'myPromise.then(function(result) {\n    console.log("Success: " + result);\n}).____(function(error) {\n    console.log("Error: " + error);\n});';

String requirement =
      'Fill in the blank to handle the result of a promise using "then" and "catch":';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'java_script_levels.level14': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
