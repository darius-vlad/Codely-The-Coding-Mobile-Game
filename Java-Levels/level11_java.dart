...
class Level11Java extends StatefulWidget {
  @override
  _Level11JavaState createState() => _Level11JavaState();
}

class _Level11JavaState extends State<Level11Java> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'void bubbleSort(int[] arr) {\n    int n = arr.length;\n    for (int i = 0; i < n-1; i++) {\n        for (int j = 0; j < n-i-1; j++) {\n            if (arr[j] > arr[____]) {\n                int temp = arr[j];\n                arr[j] = arr[j+1];\n                arr[j+1] = temp;\n            }\n        }\n    }\n}\n';
  String requirement = 'Fill in the blank to write a Java program to sort an array of integers in ascending order using the bubble sort algorithm:';
