...
class Level9Java extends StatefulWidget {
  @override
  _Level9JavaState createState() => _Level9JavaState();
}

class _Level9JavaState extends State<Level9Java> {
  TextEditingController answerController = TextEditingController();
String codeBefore = '____ isPrime(int n) {\n  if (n <= 1) {\n  return false;\n}\n  for (int i = 2; i <= Math.sqrt(n); i++) {\n    if (n % i == 0) {\n    return false;\n  }\n  }\n  return true;\n}\n';
  String requirement = 'Fill in the blank to create a method named "isPrime" that takes an integer parameter n and returns true if n is a prime number, false otherwise:';
...
String expectedSolution = 'boolean';
