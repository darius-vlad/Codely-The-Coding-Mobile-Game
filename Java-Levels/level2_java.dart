...
class Level2Java extends StatefulWidget {
  @override
  _Level2JavaState createState() => _Level2JavaState();
}

class _Level2JavaState extends State<Level2Java> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'String name = ____;';
  String requirement = 'Fill in the blank to create a string variable named "name" and assign it the value "John":';
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: Colors.greenAccent.shade100, width: 4),
                ),
                child: Text(
