...
class Level17Java extends StatefulWidget {
  @override
  _Level17JavaState createState() => _Level17JavaState();
}

class _Level17JavaState extends State<Level17Java> {
 String question = 'Which of the following data types is used to store floating-point numbers with double precision in Java?\n';
  List<String> choices = [
    'A) int',
    'B) double',
    'C) float',
