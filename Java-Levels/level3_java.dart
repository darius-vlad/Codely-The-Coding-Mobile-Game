...
class Level3Java extends StatefulWidget {
  @override
  _Level3JavaState createState() => _Level3JavaState();
}

class _Level3JavaState extends State<Level3Java> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = '____ int MAX_VALUE = 100;';
  String requirement = 'Fill in the blank to declare a constant integer variable named "MAX_VALUE" and assign it the value 100:';
