...
class Level7Java extends StatefulWidget {
  @override
  _Level7JavaState createState() => _Level7JavaState();
}

class _Level7JavaState extends State<Level7Java> {
  TextEditingController answerController = TextEditingController();
String codeBefore = 'int factorial(int n) {\n if (n == 0)\n return 1;\n  else\n return n * factorial(____);\n}';
  String requirement = 'Fill in the blank to Implement a method named "factorial" that takes an integer parameter n and returns the factorial of n:';
