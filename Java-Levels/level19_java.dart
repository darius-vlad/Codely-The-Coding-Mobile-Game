...
class Level19Java extends StatefulWidget {
  @override
  _Level19JavaState createState() => _Level19JavaState();
}

class _Level19JavaState extends State<Level19Java> {
String question = 'What does the keyword "final" do in Java?';
  List<String> choices = [
    'A) Prevents a class from being extended.',
    'B) Prevents a method from being overridden.',
    'C)  Prevents a variable from being reassigned',
    'D) All of the above',
  ];
  int correctIndex = 3;
  int selectedIndex = -1;
