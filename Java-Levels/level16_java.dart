...
class Level16Java extends StatefulWidget {
  @override
  _Level16JavaState createState() => _Level16JavaState();
}

class _Level16JavaState extends State<Level16Java> {
  String question = 'Which of the following is the correct way to declare a variable of type int named "age" and assign it the value 25?\n';
  List<String> choices = [
    'A) int age = "25";',
    'B) int age; age = "25";',
    'C) int age = 25;',
