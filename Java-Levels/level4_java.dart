...
class Level4Java extends StatefulWidget {
  @override
  _Level4JavaState createState() => _Level4JavaState();
}

class _Level4JavaState extends State<Level4Java> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'System.out.____("Hello, world!"); ';
  String requirement = 'Fill in the blank to write a Java statement to print "Hello, world!" to the console:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'println';
