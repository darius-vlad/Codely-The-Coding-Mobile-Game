...
class Level8Java extends StatefulWidget {
  @override
  _Level8JavaState createState() => _Level8JavaState();
}

class _Level8JavaState extends State<Level8Java> {
  TextEditingController answerController = TextEditingController();
String codeBefore = 'class Rectangle {\n  int length;\n  int width;\n  int calculateArea() {\n    return ____ * ____;\n  }\n}';
  String requirement = 'Fill in the blank to create a class named "Rectangle" with instance variables "length" and "width" and a method "calculateArea" that returns the area of the rectangle:(Write the answers separated by a space)';
  ...
  Future<void> checkAnswer() async {
   ...
   String expectedSolution = 'length width';
