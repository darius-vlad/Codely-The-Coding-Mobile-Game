...
class Level8CPlus extends StatefulWidget {
  @override
  _Level8CPlusState createState() => _Level8CPlusState();
}

class _Level8CPlusState extends State<Level8CPlus> {
  TextEditingController answerController = TextEditingController();
String codeBefore = 'int main() {\n std::thread t(____);\n};';
  String requirement = 'Fill in the blank to create a thread in C++ using the std::thread class, where myFunction is the function to be executed by the thread:';
  ...
  Future<void> checkAnswer() async {
   ...
   String expectedSolution = 'myFunction';
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level8': true,
    });
    } else {
      // Incorrect answer
