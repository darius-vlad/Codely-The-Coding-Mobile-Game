...
class Level2CPlus extends StatefulWidget {
  @override
  _Level2CPlusState createState() => _Level2CPlusState();
}

class _Level2CPlusState extends State<Level2CPlus> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'int main() {\n  cout<<____;\n} \n';
  String requirement = 'Complete the following C++ statement to print "Hello, World!" to the console:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'Hello World';
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level2': true,
    });
    } else {
      // Incorrect answer
