...
class Level18CPlus extends StatefulWidget {
  @override
  _Level18CPlusState createState() => _Level18CPlusState();
}

class _Level18CPlusState extends State<Level18CPlus> {
String question = 'Which of the following is not a fundamental data type in C++?';
  List<String> choices = [
    'A) int',
    'B) float',
    'C) bool',
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'c_plus_plus_levels.level18': true,
    });
      } else {
        // Incorrect answer
