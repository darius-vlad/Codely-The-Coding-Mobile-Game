...
class Level16CPlus extends StatefulWidget {
  @override
  _Level16CPlusState createState() => _Level16CPlusState();
}

class _Level16CPlusState extends State<Level16CPlus> {
  String question = 'What is the purpose of the const keyword in C++?';
  List<String> choices = [
    'A) It is used to declare a constant variable.',
    'B) It is used to declare a constructor.',
    'C) It is used to declare a friend function.',
    'D) It is used to declare a static variable.',
  ];
  int correctIndex = 0;
  int selectedIndex = -1;
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'c_plus_plus_levels.level16': true,
    });
      } else {
        // Incorrect answer
