...
class Level11CPlus extends StatefulWidget {
  @override
  _Level11CPlusState createState() => _Level11CPlusState();
}

class _Level11CPlusState extends State<Level11CPlus> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'int main()\n{\nauto sum = [](int a, int b) -> ____ { return a + b; };\n}';
  String requirement = 'Fill in the blank to define a lambda function in C++ that takes two integers as parameters and returns their sum:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level11': true,
    });
    } else {
      // Incorrect answer
