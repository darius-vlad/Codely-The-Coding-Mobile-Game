...
class Level4CPlus extends StatefulWidget {
  @override
  _Level4CPlusState createState() => _Level4CPlusState();
}

class _Level4CPlusState extends State<Level4CPlus> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'int main() {\nfor(int i=1; i<=... ; i++){\ncout<< i << " "\n}\n} \n';
  String requirement = 'Fill in the blank to create a loop that prints numbers from 1 to 5:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level4': true,
    });
    } else {
      // Incorrect answer
