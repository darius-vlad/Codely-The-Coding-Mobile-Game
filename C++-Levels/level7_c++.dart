...
class Level7CPlus extends StatefulWidget {
  @override
  _Level7CPlusState createState() => _Level7CPlusState();
}

class _Level7CPlusState extends State<Level7CPlus> {
  TextEditingController answerController = TextEditingController();
String codeBefore = 'int main() {\n template <typename T>\n T ____(T a , T b){\n return(a>b) ? a : b;\n}\n};';
  String requirement = 'Fill in the blank to define a template function named maximum that returns the maximum of two values of the same type:';
  ...
  Future<void> checkAnswer() async {
   ...
   String expectedSolution = 'maximum';
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level7': true,
    });
    } else {
      // Incorrect answer
