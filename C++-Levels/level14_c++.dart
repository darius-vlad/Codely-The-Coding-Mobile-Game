...
class Level14CPlus extends StatefulWidget {
  @override
  _Level14CPlusState createState() => _Level14CPlusState();
}

class _Level14CPlusState extends State<Level14CPlus> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'class CustomException : public ____ {\npublic:\nconst char* what() const noexcept override {\n      return "Custom exception occurred";\n}\n};';
  String requirement = 'Fill in the blank to define a custom exception class named CustomException that inherits from the standard exception class std::exception:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'std::exception';
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level14': true,
    });
    } else {
      // Incorrect answer
