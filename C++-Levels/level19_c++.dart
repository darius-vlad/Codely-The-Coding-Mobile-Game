...
class Level19CPlus extends StatefulWidget {
  @override
  _Level19CPlusState createState() => _Level19CPlusState();
}

class _Level19CPlusState extends State<Level19CPlus> {
String question = 'Which keyword is used to dynamically allocate memory in C++?';
  List<String> choices = [
    'A) alloc',
    'B) new',
    'C) malloc',
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'c_plus_plus_levels.level19': true,
    });
      } else {
        // Incorrect answer
