...
class Level5CPlus extends StatefulWidget {
  @override
  _Level5CPlusState createState() => _Level5CPlusState();
}

class _Level5CPlusState extends State<Level5CPlus> {
  TextEditingController answerController = TextEditingController();
String codeBefore = 'int main() {\n int* arr = new new ____[size];\n};';
  String requirement = 'Fill in the blank to dynamically allocate memory for an array of integers in C++:';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level5': true,
    });
    } else {
      // Incorrect answer
