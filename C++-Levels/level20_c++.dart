...
class Level20CPlus extends StatefulWidget {
  @override
  _Level20CPlusState createState() => _Level20CPlusState();
}

class _Level20CPlusState extends State<Level20CPlus> {
  String question = 'What is the function of the virtual keyword in C++?';
  List<String> choices = [
    'A) It declares a variable as constant.',
    'B) It declares a function as a pure virtual function.',
    'C) It enables dynamic polymorphism.',
    'D) It declares a variable as volatile.',
  ];
  int correctIndex = 2;
  int selectedIndex = -1;
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'c_plus_plus_levels.level20': true,
    });
      } else {
        // Incorrect answer
