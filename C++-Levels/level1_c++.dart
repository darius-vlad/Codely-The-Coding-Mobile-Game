...
class Level1CPlus extends StatefulWidget {
  @override
  _Level1CPlusState createState() => _Level1CPlusState();
}

class _Level1CPlusState extends State<Level1CPlus> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'int main() {\n  int ____;\n}';
  String requirement =
      'Fill in the blank to declare an integer variable named "count":';
  ...
  Future<void> checkAnswer() async {
    ...
    if (userAnswer == expectedSolution) {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(currentUser?.uid)
          .update({
        'c_plus_plus_levels.level1': true,
      });
    } else {
      // Incorrect answer
      showResultDialog(
