...
class Level6CPlus extends StatefulWidget {
  @override
  _Level6CPlusState createState() => _Level6CPlusState();
}

class _Level6CPlusState extends State<Level6CPlus> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'int main() {\n void (*functPtr)(int)=____;\n};';
  String requirement = 'Fill in the blank to declare a function pointer named funcPtr that points to a function taking an integer parameter and returning void:';
  @override
  ...
  Future<void> checkAnswer() async {
    ...
    // For example, you can compare the user's answer to the expected solution
     String expectedSolution = 'nullptr';
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level6': true,
    });
    } else {
      // Incorrect answer
