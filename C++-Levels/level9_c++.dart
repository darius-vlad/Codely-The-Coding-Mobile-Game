...
class Level9CPlus extends StatefulWidget {
  @override
  _Level9CPlusState createState() => _Level9CPlusState();
}

class _Level9CPlusState extends State<Level9CPlus> {
  TextEditingController answerController = TextEditingController();
String codeBefore = 'int main() {\n class Shape{\n public:\n virtual void ____() = 0;\n}\n};';
  String requirement = 'Fill in the blank to declare a pure virtual function named display in an abstract base class named Shape:';
...
String expectedSolution = 'display';
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level9': true,
    });
    } else {
      // Incorrect answer
