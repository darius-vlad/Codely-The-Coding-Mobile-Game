...
class Level13CPlus extends StatefulWidget {
  @override
  _Level13CPlusState createState() => _Level13CPlusState();
}

class _Level13CPlusState extends State<Level13CPlus> {
  TextEditingController answerController = TextEditingController();
String codeBefore = ' template <typename T, template <typename...> class Container>\ndouble average(const ____<T>& container)\n{\n}';
  String requirement = 'Fill in the blank to declare a function template named average that takes a container container of type Container containing elements of type T, and returns the average of those elements:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'Container';
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level13': true,
    });
    } else {
      // Incorrect answer
