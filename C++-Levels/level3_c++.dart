...
class Level3CPlus extends StatefulWidget {
  @override
  _Level3CPlusState createState() => _Level3CPlusState();
}

class _Level3CPlusState extends State<Level3CPlus> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'int main() {\n  const double...=...\n} \n';
  String requirement = 'Complete the following code snippet to declare and initialize a constant variable named "PI" with the value 3.14:';
  ...
  Future<void> checkAnswer() async {
   ...
   String expectedSolution = 'PI3.14';
    ...
    if (userAnswer == expectedSolution) {
      ...
      'c_plus_plus_levels.level3': true,
    });
    } else {
      // Incorrect answer
