...
class Level21CPlus extends StatefulWidget {
  @override
  _Level21CPlusState createState() => _Level21CPlusState();
}

class _Level21CPlusState extends State<Level21CPlus> {
  String question = 'What is the difference between ++i and i++ in C++?';
  List<String> choices = [
    'A)  ++i increments the value of i after using it, while i++ increments it before using it.',
    'B) There is no difference.',
    'C) ++i increments the value of i by 1, while i++ increments it by 2.',
    'D) ++i decrements the value of i after using it, while i++ decrements it before using it.',
  ];
  int correctIndex = 0;
  int selectedIndex = -1;
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'c_plus_plus_levels.level21': true,
    });
      } else {
        // Incorrect answer
