...
class Level17CPlus extends StatefulWidget {
  @override
  _Level17CPlusState createState() => _Level17CPlusState();
}

class _Level17CPlusState extends State<Level17CPlus> {
 String question = 'What is the output of the following code snippet?\nint x = 5;\nint* ptr = &x;\ncout << *ptr;\n';
  List<String> choices = [
    'A) 5',
    'B) Address of x',
    'C) Garbage value',
  ...
  Future<void> checkAnswer() async {
    ...
    if (selectedIndex != -1) {
      ...
      'c_plus_plus_levels.level17': true,
    });
      } else {
        // Incorrect answer
