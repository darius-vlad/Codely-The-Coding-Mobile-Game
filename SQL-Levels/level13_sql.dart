...
class Level13SQL extends StatefulWidget {
  @override
  _Level13SQLState createState() => _Level13SQLState();
}

class _Level13SQLState extends State<Level13SQL> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'SELECT employees.employee_name, projects.project_name, projects.start_date, projects.end_date\nFROM employees\nJOIN ____ ON employees.employee_id = employee_projects.employee_id\nJOIN projects ON employee_projects.project_id = projects.project_id\nWHERE projects.project_name = "YourProjectName";';

  String requirement =
      'Fill in the blank to list the employees who have been assigned to a specific project along with the project details:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'employee_projects';
