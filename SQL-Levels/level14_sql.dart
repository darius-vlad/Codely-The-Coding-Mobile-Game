...
class Level14SQL extends StatefulWidget {
  @override
  _Level14SQLState createState() => _Level14SQLState();
}

class _Level14SQLState extends State<Level14SQL> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'SELECT AVG(DATEDIFF(CURRENT_DATE, birth_date)/____) AS average_age\nFROM employees\nWHERE department = ''HR'';';

  String requirement =
      'Fill in the blank to calculate the average age of employees in the HR department:';
