...
class Level10SQL extends StatefulWidget {
  @override
  _Level10SQLState createState() => _Level10SQLState();
}

class _Level10SQLState extends State<Level10SQL> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'SELECT COUNT(employee_id) AS long_serving_employees\nFROM employees\nWHERE hire_date <= DATE_SUB(CURRENT_DATE, ____ 5 YEAR);';

  String requirement =
      'Fill in the blank to determine the number of employees who have been with the company for more than 5 years:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'INTERVAL';
