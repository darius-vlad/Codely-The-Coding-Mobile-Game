...
class Level7SQL extends StatefulWidget {
  @override
  _Level7SQLState createState() => _Level7SQLState();
}

class _Level7SQLState extends State<Level7SQL> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = "SELECT * FROM employees WHERE name LIKE '____';";
  String requirement =
      'Fill in the blank to retrieve records from the "employees" table where the "name" starts with "J":';
