...
class Level2SQL extends StatefulWidget {
  @override
  _Level2SQLState createState() => _Level2SQLState();
}

class _Level2SQLState extends State<Level2SQL> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'SELECT ____ FROM employees;';
  String requirement =
      'Fill in the blank to retrieve only the "name" column from the "employees" table:';
