...
class Level3SQL extends StatefulWidget {
  @override
  _Level3SQLState createState() => _Level3SQLState();
}

class _Level3SQLState extends State<Level3SQL> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'SELECT ____ department FROM employees;';
  String requirement =
      'Fill in the blank to retrieve unique values from the "department" column in the "employees" table:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'DISTINCT';
