...
class Level19SQL extends StatefulWidget {
  @override
  _Level19SQLState createState() => _Level19SQLState();
}

class _Level19SQLState extends State<Level19SQL> {
  String question = 'Which of the following SQL functions can be used to find the total number of rows in a table?\n';
  List<String> choices = [
    'A) COUNT(*);',
    'B) TOTAL_ROWS();',
    'C) ROW_COUNT();',
