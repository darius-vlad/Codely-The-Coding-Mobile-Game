...
class Level20SQL extends StatefulWidget {
  @override
  _Level20SQLState createState() => _Level20SQLState();
}

class _Level20SQLState extends State<Level20SQL> {
  String question = 'In SQL, what is the purpose of the GROUP BY clause?\n';
  List<String> choices = [
    'A) To specify conditions for filtering rows returned by a query;',
    'B) To join tables based on specified conditions;',
    'C) To order the result set in ascending or descending order;',
    'D) To aggregate data based on specified columns, often used with aggregate functions like SUM or AVG;',
  ];
  int correctIndex = 3;
  int selectedIndex = -1;
