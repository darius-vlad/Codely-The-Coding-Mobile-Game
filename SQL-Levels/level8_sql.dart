...
class Level8SQL extends StatefulWidget {
  @override
  _Level8SQLState createState() => _Level8SQLState();
}

class _Level8SQLState extends State<Level8SQL> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'SELECT * FROM employees ORDER BY age ____;';
  String requirement =
      'Fill in the blank to retrieve records from the "employees" table sorted by "age" in descending order:';
