...
class Level15SQL extends StatefulWidget {
  @override
  _Level15SQLState createState() => _Level15SQLState();
}

class _Level15SQLState extends State<Level15SQL> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'SELECT customers.customer_name, SUM(order_details.unit_price * order_details.quantity) AS total_spent\nFROM customers\nJOIN orders ON customers.customer_id = orders.customer_id\nJOIN order_details ON orders.order_id = order_details.order_id\nGROUP BY customers.customer_id\nORDER BY ____ DESC\nLIMIT 5;';


  String requirement =
      'Fill in the blank to retrieve the top 5 customers who have spent the highest total amount across all their orders:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'total_spent';
