...
class Level1SQL extends StatefulWidget {
  @override
  _Level1SQLState createState() => _Level1SQLState();
}

class _Level1SQLState extends State<Level1SQL> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = '____ * FROM employees;';
  String requirement =
      'Fill in the blank to retrieve all columns from the "employees" table:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'SELECT';
