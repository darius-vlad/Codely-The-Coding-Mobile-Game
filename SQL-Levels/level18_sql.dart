...
class Level18SQL extends StatefulWidget {
  @override
  _Level18SQLState createState() => _Level18SQLState();
}

class _Level18SQLState extends State<Level18SQL> {
  String question = 'In SQL, which clause is used to filter the results of a query based on specified conditions?\n';
  List<String> choices = [
    'A) HAVING;',
    'B) FILTER;',
    'C) WHERE;',
