...
class Level11SQL extends StatefulWidget {
  @override
  _Level11SQLState createState() => _Level11SQLState();
}

class _Level11SQLState extends State<Level11SQL> {
  TextEditingController answerController = TextEditingController();
 String codeBefore = 'SELECT order_id, total_price\nFROM (\n    SELECT order_id, SUM(unit_price * quantity) AS total_price\n    FROM order_details\n    JOIN orders ON order_details.order_id = orders.order_id\n    WHERE order_date >= DATE_SUB(CURRENT_DATE, INTERVAL 1 YEAR)\n    GROUP BY order_id\n    ORDER BY total_price DESC\n    LIMIT ____\n) AS top_orders;';

  String requirement =
      'Fill in the blank to list the top 3 most expensive orders placed in the past year:';
