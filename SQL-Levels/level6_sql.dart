...
class Level6SQL extends StatefulWidget {
  @override
  _Level6SQLState createState() => _Level6SQLState();
}

class _Level6SQLState extends State<Level6SQL> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'SELECT * FROM employees WHERE salary ____ 30000 ____ 50000;';
  String requirement =
      'Fill in the blank to retrieve records from the "employees" table where the "salary" is between 30000 and 50000:';
  ...
  Future<void> checkAnswer() async {
    ...
    String expectedSolution = 'BETWEEN AND';
