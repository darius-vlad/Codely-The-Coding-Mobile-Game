...
class Level4SQL extends StatefulWidget {
  @override
  _Level4SQLState createState() => _Level4SQLState();
}

class _Level4SQLState extends State<Level4SQL> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'SELECT ____(*) FROM employees;';
  String requirement =
      'Fill in the blank to count the total number of records in the "employees" table:';
