...
class Level5SQL extends StatefulWidget {
  @override
  _Level5SQLState createState() => _Level5SQLState();
}

class _Level5SQLState extends State<Level5SQL> {
  TextEditingController answerController = TextEditingController();
  String codeBefore = 'SELECT * FROM employees ____ age > 30;';
  String requirement =
      'Fill in the blank to retrieve records from the "employees" table where the "age" is greater than 30:';
