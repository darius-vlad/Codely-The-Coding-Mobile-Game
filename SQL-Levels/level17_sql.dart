...
class Level17SQL extends StatefulWidget {
  @override
  _Level17SQLState createState() => _Level17SQLState();
}

class _Level17SQLState extends State<Level17SQL> {
  String question = 'Which SQL keyword is used to retrieve data from a database?\n';
  List<String> choices = [
    'A) FETCH;',
    'B) SELECT;',
    'C) GET;',
