...
class Level21SQL extends StatefulWidget {
  @override
  _Level21SQLState createState() => _Level21SQLState();
}

class _Level21SQLState extends State<Level21SQL> {
String question = 'Which of the following SQL statements would you use to add a unique constraint to an existing table?';
  List<String> choices = [
    'A) ALTER TABLE table_name ADD CONSTRAINT constraint_name UNIQUE (column_name);',
    'B) ALTER TABLE table_name ADD UNIQUE CONSTRAINT constraint_name (column_name);',
    'C) MODIFY TABLE table_name ADD UNIQUE CONSTRAINT constraint_name (column_name);',
    'D) ADD CONSTRAINT UNIQUE (column_name) TO TABLE table_name;',
  ];
  int correctIndex = 1;
  int selectedIndex = -1;
